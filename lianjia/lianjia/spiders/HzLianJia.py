...
class HzLianJia(CrawlSpider):
    ...
    def parse_second(self, response):
        ...
        while list_content:
            ...
            if url_search:
                ...
                items["subway"] = sub_match.group(1) if sub_match else ""
                items["deal_date"] = deal_date_match.group(1) if deal_date_match else ""
    ...
    def parse_third(self, response):
        ...
        items["deal_ship"] = selector.xpath(
                '//*[@id="introduction"]/div/div[2]/div[2]/ul/li[2]/text()').extract()[0]  # 交易权属
